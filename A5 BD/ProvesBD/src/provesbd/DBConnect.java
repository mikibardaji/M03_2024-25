...
public class DBConnect {
    ...
    static final String BD_NAME = "paisesdb"; //nombre base datos NO LA TABLA!
    static final String USER = "paisesdb"; //usuari per accedir a la base de dades
    static final String PASSWORD = "paisesdb"; //password 
